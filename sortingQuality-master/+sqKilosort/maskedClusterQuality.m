...
% MML edit:
cluster_labels = tdfread(fullfile(resultsDirectory, 'cluster_info.tsv'));
cluster_labels = cluster_labels.group(:,1);
...
[clusterIDs, unitQuality, contaminationRate] = maskedClusterQualitySparse(spike_clusters, pc_features, pc_feature_ind, cluster_labels);
