...
function [clusterIDs, unitQuality, contaminationRate] = maskedClusterQualitySparse(clu, fet, fetInds, labels, fetNchans)
% - clu is 1 x nSpikes
...
%     end
    ...
    fprintf('cluster %3d: \t%6.1f\t%6.2f\t%s\n', clusterIDs(c), unitQuality(c), contaminationRate(c), labels(c)); % comment to suppress printing out the intermediate results
