function caraslab_batch_gpufilter(Savedir,sel)
...
%
% Adapted from Kilosort2 by M Macedo-Lima 08/24/20
...
for i = 1:numel(datafolders)
    ...
    for ibatch = 1:Nbatch
        ...
        % MML comment: the Kilosort2 offset is different than this;
        % I raised an issue on this here https://github.com/MouseLand/Kilosort2/issues/223
        % Not yet addressed by developers as of 9/8/20
        ...
        if getOr(ops, 'rm_artifacts', 1)
            [datr, ~] = caraslab_artifact_reject(datr, ops.fs);
        end
