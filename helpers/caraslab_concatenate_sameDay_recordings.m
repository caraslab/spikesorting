function caraslab_concatenate_sameDay_recordings(Savedir, sel, chanMap, recording_type)
%
...
% Patched by M Macedo-Lima June, 2021
% NEW IN THIS VERSION:
% - New breakpoints.csv has a new column with values in seconds. 
%       This makes more sense to adapt to different sampling rates right off the bat
...
try
    for i=1:length(date_time)
    	switch recording_type
            ...
            case 'intan'
                recording_dates = [recording_dates str2num(cell2mat(date_time{i}(1:3)))];
